...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By fasil ser' : process.env.ALL_CAPTION,
    ...
    BOT: process.env.BOT_NAME === undefined ? 'Zᴀʀᴀ ʙᴀʙʏ : process.env.BOT_NAME,
    ...
    SONGD: process.env.SONGD === undefined ? '*W8 SONG DOWNLOAD AKKATTE*🌚' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '```Feel the song```' : process.env.SONGU,
    TALKING_AJUSER: process.env.TALKING_FASIL-SER === undefined ? 'false' : process.env.TALKING_FASIL-SER,
